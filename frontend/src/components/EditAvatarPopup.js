...
function EditAvatarPopup ({ onClose, isOpened, onUpdateAvatar }) {
  ...
  //прокинуть popupwithform
    return (
      	<PopupWithForm 
			namePopup="popup popup-profile" nameForm="form form-profile" title="Обновить аватар"
			button="Сохранить" buttonLoad="Сохранение..." heading="form__heading_profile"
			isOpened = { isOpened } onClose = { onClose } onSubmit={ handleSubmit }
